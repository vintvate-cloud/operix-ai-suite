    ...
    <section ref={ref} className="relative bg-foreground text-background pt-36 pb-24 px-4 overflow-hidden">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <h1 className="font-display text-[15vw] sm:text-[11vw] lg:text-[140px] leading-[0.9]">
          ...
          <span className="block overflow-hidden"><span className="hero-line inline-block">business from one</span></span>
        ...
        <p className="hero-cta mt-10 mx-auto max-w-2xl text-lg sm:text-xl text-background/75 leading-relaxed">
          Everything your business needs to operate and grow — ERP, POS, Website, Mobile App, CRM, SEO, AI and Marketing in one subscription.
        </p>
      ...
      <div className="mt-20 w-full grid grid-cols-6 sm:grid-cols-12 gap-3 px-2 sm:px-6">
        <div className="hero-tile col-span-2 aspect-square rounded-full bg-op-pink animate-float flex items-center justify-center text-3xl">🚀</div>
        ...
        <div className="hero-tile col-span-3 sm:col-span-4 rounded-3xl bg-op-pink/70 aspect-[2/1] animate-float [animation-delay:1s] flex items-center justify-center text-background/70 font-display text-2xl">ERP</div>
        <div className="hero-tile col-span-6 sm:col-span-4 rounded-3xl bg-op-peach aspect-[2/1] animate-float [animation-delay:0.2s] flex items-center px-6 text-foreground/70 font-display text-2xl">MARKETING</div>

        <div className="hero-tile col-span-6 sm:col-span-5 rounded-3xl bg-op-peach aspect-[2.2/1] animate-float [animation-delay:0.7s] flex items-center px-6 text-foreground/70 font-display text-2xl">WEBSITE & SEO</div>
        <div className="hero-tile col-span-2 aspect-square rounded-full bg-op-beige animate-float [animation-delay:1.2s] flex items-center justify-center text-3xl">📱</div>
        ...
        <div className="hero-tile col-span-2 aspect-square rounded-full bg-op-pink animate-float [animation-delay:1.4s] flex items-center justify-center text-3xl">🛒</div>
    ...
    <section className="bg-background py-24 px-4">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <h2 className="text-4xl sm:text-5xl font-semibold tracking-tight">
          Trusted by 2,300+ businesses globally
        </h2>
      </div>
...
function Industries() {
  const industries = [
    { name: "Hotels", icon: Hotel, features: ["PMS", "Booking", "Housekeeping", "Revenue Management"], color: "bg-op-purple" },
    { name: "Restaurants", icon: ShoppingCart, features: ["POS", "Kitchen Display", "Inventory"], color: "bg-op-pink" },
    { name: "Gyms", icon: Users, features: ["Memberships", "Trainers", "Attendance"], color: "bg-op-orange" },
    { name: "Construction", icon: Wrench, features: ["Projects", "Procurement", "Site Management"], color: "bg-op-peach" },
    { name: "Clinics", icon: Plus, features: ["Appointments", "Patient Records", "Billing"], color: "bg-op-beige" },
  ];
  return (
    <section className="bg-background py-24 px-4">
      <div className="max-w-4xl mx-auto text-center px-4">
        <p className="text-muted-foreground mb-3">Industries</p>
        <h2 className="text-4xl sm:text-6xl font-semibold tracking-tight leading-[1.05]">
          Different industries.<br/>Same intelligent core.
        </h2>
      </div>
      <div className="mt-16 max-w-6xl mx-auto grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {industries.map((ind) => (
          <div key={ind.name} className={`group bg-muted rounded-3xl p-6 hover-lift cursor-pointer`}>
            <div className={`h-12 w-12 rounded-xl flex items-center justify-center mb-6 text-foreground ${ind.color}`}>
              <ind.icon className="h-6 w-6" />
            </div>
            <div className="text-2xl font-display mb-4">{ind.name}</div>
            <ul className="space-y-2 mt-4">
              {ind.features.map((f) => (
                <li key={f} className="text-sm font-medium flex items-center gap-2 text-muted-foreground group-hover:text-foreground transition-colors">
    ...
    <section id="flagship" className="bg-foreground text-background rounded-[36px] mx-3 sm:mx-6 my-6 px-6 sm:px-12 py-20 sm:py-28">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 className="font-display text-5xl sm:text-7xl leading-[0.95] mt-4 max-w-4xl">
          Ten reasons businesses rip out their legacy software.
        </h2>
  ...
  return (
    <main className="bg-background text-foreground">
      ...
      <div className="text-center pt-8 pb-4">
        <p className="text-muted-foreground">ERP. POS. CRM. Website. Mobile App. AI.</p>
        <h2 className="mt-3 text-4xl sm:text-6xl font-semibold tracking-tight max-w-3xl mx-auto px-4 leading-[1.05]">
          Your whole business, finally connected in one workflow
        </h2>
      </div>
      <AICommandCenter />
      <ReservationsCard />
